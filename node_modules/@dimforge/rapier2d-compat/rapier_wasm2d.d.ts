...
export interface InitOutput {
  ...
  readonly rawcolliderset_coTriMeshFlags: (a: number, b: number, c: number) => void;
  ...
  readonly __wbg_rawcollidershapecasthit_free: (a: number) => void;
  ...
  readonly rawquerypipeline_castShape: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number, l: number, m: number, n: number, o: number, p: number, q: number, r: number) => number;
  ...
  readonly __wbg_rawraycolliderhit_free: (a: number) => void;
  readonly __wbg_rawshapecasthit_free: (a: number) => void;
